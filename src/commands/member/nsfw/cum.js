  ...
  handle: async ({
    ...
    if (!targetJid) {
      await sendErrorReply(
        "Debes mencionar a un usuario o responder a un mensaje para lechazo."
      );
      return;
    }
    ...
    await sendGifFromFile(
      path.resolve(ASSETS_DIR, "images", "funny", "cum.mp4"),
      `@${userNumber} se vino dentro de @${targetNumber}!`,
      [userJid, targetJid]
    );
  },
};
